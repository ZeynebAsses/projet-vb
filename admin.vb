Public Class admin
    ...
    Private Sub btnAjouter_Click(sender As Object, e As EventArgs) Handles btnAjouter.Click
        ...
        AfficherVols()
        MessageBox.Show("Vol ajouté.", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information)
    End Sub
    ...
    Private Sub btnModifier_Click(sender As Object, e As EventArgs) Handles btnModifier.Click
        ...
        MessageBox.Show("Vol modifié .", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information)
    End Sub
    ...
    Private Sub btnSupprimer_Click(sender As Object, e As EventArgs) Handles btnSupprimer.Click
        ...
        MessageBox.Show("Vol supprimé .", "Info", MessageBoxButtons.OK, MessageBoxIcon.Information)
    End Sub
